...
v3 authentification is preferred. It will be set later if 
...
=head3 Usage: C<$os_cli-<gt>request($req, $filter)>
...
Provided for chaining in caller.
...
# TODO: Load mutators from module.
...
# TODO: Move to module for require.

=head1 B<Request Mutators>

Methods that transform requests 

=head2 Name: B<request_trace>
